...
import { Home, Users, MessageCircle, UserPlus, ArrowRight, X } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white text-black">
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl sm:text-2xl mb-8 opacity-90 animate-fade-in-up animation-delay-200">
              The all-in-one platform for Indian students in the USA. Find housing, build your network, and get the support you need - all in one place.
            </p>
            <Link
              href="/home"
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">How DesiDwaar Transforms Your Experience</h2>
          <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 md:space-x-4">
            <EnhancedStepCard number={1} title="Create your profile and join a thriving community" />
            <ArrowRight className="hidden md:block w-8 h-8 text-blue-300" />
            <EnhancedStepCard number={2} title="Access curated listings and expert advice" />
            <ArrowRight className="hidden md:block w-8 h-8 text-blue-300" />
            <EnhancedStepCard number={3} title="Connect, settle in, and thrive in your new home" />
          </div>
        </div>
      </section>
...
function EnhancedFeatureCard({ icon, title, description, image }: EnhancedFeatureCardProps) {
  return (
